...
insert into products (id, name, description, code, price, typemerk_id) values (7, 'Beyerd Koptelefoon', 'Deze koptelefoon heeft een uitstekende stereo geluidskwaliteit en het bevat ook hele goede geluidsdemping.', '5671341443-3', 149.99);
insert into products (id, name, description, code, price, typemerk_id) values (8, 'Swissten grijze koptelefoon', 'De koptelefoon van het zwitserse merk met een hele goede kwaliteit. Deze koptelefoon is voor de echte genieters van muziek.', 119.99);)
insert into products (id, name, description, code, price, typemerk_id) values (9, 'Grundig Koptelefoon', 'Deze koptelefoon is van een zeer goed en betrouwbaar Duits merk. De geluidskwaliteit is van middelmatige kwaliteit, maar voor de prijs is het de beste deal', 49.99);
insert into products (id, name, description, code, price, typemerk_id) values (10, 'Swissten zwarte koptelefoon', 'Een koptelefoon van een zwitsers merk. De kwaliteit is geweldig en het geluid dat je ermee krijgt is ook uitstekend.', 79.99);
